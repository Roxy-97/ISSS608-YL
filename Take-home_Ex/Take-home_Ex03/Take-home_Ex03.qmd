...
### **Task 3: Pseudonym Identification**Task 3.1 Expand visualizations to reveal who is using pseudonyms
...
nodes_viz <- nodes_viz %>%
  mutate(
    x = sample(-600:600, n(), replace = TRUE),
    y = sample(-400:400, n(), replace = TRUE)
  )
