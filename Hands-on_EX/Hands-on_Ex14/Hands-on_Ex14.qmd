---
title: "Hands-on Exercise 8 Part A:Building Ternary Plot with R"
author: "Yang Lu"
date: "17 Jun 2025"
...
# **Lesson 14: Creating Ternary Plot with R**

## **14.1 Overview**

Ternary plots are a way of displaying the distribution and variability of **three-part compositional data**. (For example, the proportion of aged, economy active and young population or sand, silt, and clay in soil.) Its display is a t**riangle with sides scaled from 0 to 1**. Each side represents one of the three components. A point is plotted so that a line drawn perpendicular from the point to each leg of the triangle intersect at the component values of the point.

In this hands-on, will learn how to build ternary plot programmatically using R for visualising and analysing population structure of Singapore.
...
### **14.4.1Plotting a static ternary diagram**
