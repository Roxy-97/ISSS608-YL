---
title: "Hands-on Exercise 8 Part C:Visual Multivariate Analysis with Heatmap"
author: "Yang Lu"
date: "18 Jun 2025"
...
# **Lesson 16: Heatmap for Visualising and Analysing Multivariate Data**
...
Next,will use the code chunk below to install and launch **seriation**, **heatmaply**, **dendextend** and **tidyverse** in RStudio.
...
### **14.6.1 Importing the data set**

In the code chunk below, **read_csv()** of *readr* is used to import WHData-2018.csv into R and parsed it into tibble R data frame format.

```{r}
wh <-read.csv("Hands-on_Ex09/data/WHData-2018.csv")
