...
# **Lesson 19: Information Dashboard Design: R methods**
...
```{r}
R.Version()$arch
# – returns "x86_64" for 64-bit, "i386" for 32-bit
...
# connect assess to 64bit
con <- dbConnect(odbc::odbc(),
                 Driver = "Microsoft Access Driver (*.mdb, *.accdb)",
                 Dbq    = "Hands-on_Ex10/data/Coffee Chain.mdb")

# loading data
coffeechain <- dbReadTable(con, "CoffeeChain Query")

# coffeechain <- dbGetQuery(con, "SELECT * FROM [CoffeeChain Query]")

# save data
saveRDS(coffeechain, "Hands-on_Ex10/data/CoffeeChain.rds")
dbDisconnect(con)
...
\###**19.6.3 Combining the data.frame** Next, use the code chunk below to add the statistics on the table.
...
\###**31.6.5 Combining bullet chart and sparklines** Similarly, we can combining the bullet chart and sparklines using the steps below.
