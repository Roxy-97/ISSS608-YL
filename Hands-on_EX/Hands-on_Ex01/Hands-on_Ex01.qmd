...
fill controls inside fill \[Works on ： bar charts, histograms，boxplots etc.\] colour（color）controls border/outline color \[Works on ： Line plots, scatter plots，edges etc.\]
