---
title: "Hands-on Exercise 8 Part D:Treemap Visualisation with R"
author: "Yang Lu"
date: "19 Jun 2025"
...
# **Lesson 18: Treemap Visualisation with R**
...
Who are new to **dplyr** methods should consult [Introduction to dplyr](https://cran.r-project.org/web/packages/dplyr/vignettes/dplyr.html) before moving on to the next section.
:::
...
::: {.callout-important style="background-color:white;"}
...
# 0. point to a non‐interactive CRAN mirror
options(repos = c(CRAN = "https://cloud.r-project.org"))

# 1. install devtools if missing
if (!requireNamespace("devtools", quietly = TRUE)) {
  install.packages("devtools")
}

# 2. install d3treeR from GitHub if missing
