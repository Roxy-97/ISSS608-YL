---
title: "Hands-on Exercise 8 Part B:Visual Correlation Analysis"
author: "Yang Lu"
date: "18 Jun 2025"
...
# **Lesson 15: Visual Correlation Analysis**
...
To show the upper half of the correlation matrix, the upper.panel argument will be used as shown in the code chunk below.
...
Similarly,can display the lower half of the correlation matrix by using the code chun below.
...
## **Usage: panel.cor(x, y, digits = 2, prefix = "", cex.cor)**
...
::: {.callout-note style="background-color:white;" icon="false"}
...
grouped_ggcorrmat(
  ...
  plotgrid.args  = list(ncol = 2, byrow = TRUE),
  ggcorrplot.args= list(
    outline.color = "black",
    hc.order      = TRUE,
    tl.cex        = 8     # this shrinks the variable‐axis labels
  ),
  annotation.args = list(
    tag_levels = c("a", "b"),           # two panels get tags "a" & "b"
    title      = "Correlogram for wine dataset",
    subtitle   = "The measures are:\nalcohol, sulphates, fixed acidity, citric acid, chlorides, residual sugar, density, free sulfur dioxide and volatile acidity",
...
corrplot(wine.cor, 
               ...
               diag = FALSE,
               tl.col = "black",
               tl.pos    = "lt", # draw labels on Left & Top of the matrix
               tl.cex    = 0.8,  # shrink the text labels (default ~1.0)
               tl.offset = 0.3,  # move the labels 0.3 units away from the tiles
               cl.pos    = "b",       # put the colour‐legend at the Bottom
               cl.cex    = 0.9,       # shrink legend tick labels
               cl.offset = 0.5        # move the legend 0.5 units away from the tiles
)
...
![](images/clipboard-1701256951.png){width="496"}
